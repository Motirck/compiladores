...
corpofuncao: corpoForSemChaves | corpoForComChaves;
corpoForSemChaves: Tfor TabreParenteses TIPO Tvar Tigual Tvalor TpontoVirgula Tvar Tmenor Tvar TpontoVirgula Tvar Tmais Tmais TfechaParenteses corpoFor;
corpoForComChaves: Tfor TabreParenteses TIPO Tvar Tigual Tvalor TpontoVirgula Tvar Tmenor Tvar TpontoVirgula Tvar Tmais Tmais TfechaParenteses TabreChaves corpoFor2;
corpoFor: Tvar TabreColchete Tvar TfechaColchete Tigual Tvalor TpontoVirgula TfechaChaves declararMiasFuncaoOuIrProMain;
corpoFor2: Tvar TabreColchete Tvar TfechaColchete Tigual Tvalor TpontoVirgula TfechaChaves TfechaChaves declararMiasFuncaoOuIrProMain;
declararMiasFuncaoOuIrProMain: declararFuncao | funcaoMain;
funcaoMain: Tint Tmain  TabreParenteses TfechaParenteses TabreChaves corpoFuncaoMain;
